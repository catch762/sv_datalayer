...
const LimitedIntOrDoubleVec& LimitedValueVecSlidersWidget::getValue() const
{
    return value;
}

void LimitedValueVecSlidersWidget::setValue(const LimitedIntOrDoubleVec& newValue)
{
    value = newValue;
...
void LimitedValueVecSlidersWidget::onSomethingChanged()
{
...
void LimitedValueVecSlidersWidget::setCurrentValueFromWidgetsState()
{
    std::visit([this](auto&& value)
    {
        ...
        {
            SV_LOG(std::format("LimitedValueVecSlidersWidget, set val from widgets: valueSize[{}] but widgetsSize[{}], will resize",
...
void LimitedValueVecSlidersWidget::setBasicWidgetsCount(int requiredBasicWidgetsCount)
{
